        ...
        <div class="card card-registration my-4">
          <div class="row g-0">
            <div class="col-xl-6 d-none d-xl-block">
              <img src="assets/img/bg-form.jpg"
                alt="Sample photo" class="img-fluid"
                style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem;" />
            </div>
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Ajukan Pengajuan Kredit</h3>

                <div class="row">
                  <div class="col-md-12 mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="form3Example1m">Nama Depan</label>
                  ...
                  <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                    ...
                    <div class="form-check form-check-inline mb-0">
                      ...
                      value="option3" />
                      <label class="form-check-label" for="otherGender">Lainya</label>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="form3Example1m1">Telepon</label>
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="form3Example1n1">Alamat Email</label>
                ...
                <div class="form-outline mb-4">
                  ...
                  <textarea id="form3Example8" class="form-control form-control-lg" cols="3">
